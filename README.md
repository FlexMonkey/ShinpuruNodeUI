...
* `func nodesAreRelationshipCandidates(sourceNode: SNNode, targetNode: SNNode, targetIndex: Int) -> Bool` returns a Boolean indicating whether a given source node is a suitable candidate to act as an input to a target node at a specified index.
